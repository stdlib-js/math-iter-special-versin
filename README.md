...
```javascript
import iterVersin from 'https://cdn.jsdelivr.net/gh/stdlib-js/math-iter-special-versin@v0.2.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/math-iter-special-versin/actions/workflows/test.yml/badge.svg?branch=v0.2.0
[test-url]: https://github.com/stdlib-js/math-iter-special-versin/actions/workflows/test.yml?query=branch:v0.2.0
